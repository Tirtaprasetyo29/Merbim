...
<body class="bg-gradient-primary">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              ...
              <img src="../assets/sb-admin/img/admin.png" alt="">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Administrator Merbim</h1>
                  </div>
                    ...
                    <hr>
                        <div class="text-center">
                            <h4 class="text-gray-500 mb-4">
                                Meris Bimbingan Belajar
                            </h4>
                            <p>@2020 All Rights Reserved. Sb-admin template. Privacy and Terms</p>
                        </div>
                  </form>
                  <hr>
  ...
  <script src="../assets/sb-admin/bootstrap/js/bootstrap.bundle.min.js"></script>
